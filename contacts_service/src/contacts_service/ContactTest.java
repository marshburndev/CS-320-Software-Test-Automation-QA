...
class ContactTest {
	...
	void IDLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("55555555556", "Lord", "Bendtner", "6656554882", "a street");
		});
	}
	...
	void NullIDException() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("", "Nicholls", "Lad", "6656554882", "a street");
		});
	}
	...
	void FirstNameLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> {
		Contact contact = new Contact("55555555556", "LordScoredALotOfHeaders", "Bendtner", "6656554882", "a street");
		});
	}
	...
	void FirstNameNullException() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("", "", "Lad", "6656554882", "a street");
		});
	}
	...
	void LastNameLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> {
		Contact contact = new Contact("55555555556", "LordScoredALotOfHeaders", "BendtnerZZ", "6656554882", "a street");
		});
	}
	...
	void LastNameNullException() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("", "", "", "6656554882", "a street");
		});
	}
	...
	void PhoneWithLessThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("1", "Zlatan", "Ibrahimovic", "555555555", "a street");
		});
	}
	...
	void PhoneWithMoreThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("1", "Alex", "Lacazette", "55555555555", "a street");
		});
	}
	...
	void NullPhoneTest() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("1", "Martin", "Odegaard", "", "a street");
		});
	}
	...
	void AddressLongerThanThirtyChar() {
		assertThrows(IllegalArgumentException.class, () -> {
		Contact contact = new Contact("55555555556", "LordScoredALotOfHeaders", "BendtnerZZ", "6656554882", "a street00000000000000000000000");
		});
	}
	...
	void AddressNullException() {
		assertThrows(IllegalArgumentException.class, () -> {
			Contact contact = new Contact("", "", "", "6656554882", "");
		});
	}
