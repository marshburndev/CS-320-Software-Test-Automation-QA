...
class ContactTest {
	...
	private String id = "1";
	private String nameTen = "aaaaaaaaaa";
	...
	void idLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> new Contact("12345678910", name, nameLast, number, address));
	}

	@Test
	void nullIDException() {
		assertThrows(IllegalArgumentException.class, () -> new Contact("", name, nameLast, number, address));
	}
	...
	void firstNameLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, "aaaaaaaaaaa", nameLast, number, address));
	}

	@Test
	void firstNameNullException() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, "", nameLast, number, address));
	}
	...
	void lastNameLongerThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, name, "aaaaaaaaaaaa", number, address));
	}

	@Test
	void lastNameNullException() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, name, "", number, address));
	}
	...
	void phoneWithMoreThanTenChar() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, name, nameLast, "55555555555", address));
	}

	@Test
	void nullPhoneTest() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, name, nameLast, "", address));
	}
	...
	void addressNullException() {
		assertThrows(IllegalArgumentException.class, () -> new Contact(id, name, nameLast, number, ""));
	}
}
