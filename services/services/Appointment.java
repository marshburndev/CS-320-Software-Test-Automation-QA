...
public class Appointment {
	private final int idLength = 10;  //Id length can be no longer than 10 characters
	private final int descriptionLength = 50;  //Description can be no longer than 50 characters.
