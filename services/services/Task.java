...
public class Task {
  ...
  private final int nameLength = 20; //Name fields must not be longer than 20 characters & not be null.
  private final int descriptionLength = 30; //Description field no longer than 30 characters & not be null.
  ...
  // Setters
  // No setter for Id as this must not be updateable. 
